...
//#warning 注：这里textLabel的宽度之所以要增加，是因为TTTAttributedLabel的bug，在文字有"."的情况下，有可能显示不出来，开发者可以帮忙定位TTTAttributedLabel的这个bug^.^
        ...
        NSString *msg = [MQServiceToViewInterface convertToUnicodeWithEmojiAlias:message.content];
        //匹配消息文字中的正则
        self.numberRangeDic = [self createRegexMap:[MQChatViewConfig sharedConfig].numberRegexs for:msg];
        self.linkNumberRangeDic = [self createRegexMap:[MQChatViewConfig sharedConfig].linkRegexs for:msg];
        self.emailNumberRangeDic = [self createRegexMap:[MQChatViewConfig sharedConfig].emailRegexs for:msg];
